...
args::ValueFlag	<float> 			argCellSize(argParser, "cell size", "Size of the grid cell", {'s'});
args::ValueFlag	<float> 			argToleranceZ(argParser, "height tolerance", "Tolerance value for height clip", {'z'});
